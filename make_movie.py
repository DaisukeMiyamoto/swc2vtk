...
for i, name in enumerate(cellname_list):
    vtkfile_base = '/home/nebula/work/paraview/sb_movie_long20170109/c' + str(i) + '_%d.vtk'
...
for i, name in enumerate(cellname_list):
    vtkfile_base = '/home/nebula/work/paraview/sb_movie_long20170109/c' + str(i + len(cellname_list)) + '_%d.vtk'
